...
class MessengerStatistics (tkinter.Tk):
    ...
    def create_menu(self):
        ...
        self.menu2.add_command(label = "Conversations les plus actives", command = lambda: self.show_most_active_conversation())
    ...
    def show_global_stats(self):
        ...
        label_subtitle_stats = tkinter.Label(self, text = "Statistiques par conversation", font = ("Arial", 16, "bold", "underline"))
